#line 1 "Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_timebase_tim_template.c"
...
#line 46 "Drivers\\STM32F4xx_HAL_Driver\\Src\\stm32f4xx_hal_timebase_tim_template.c"
...
HAL_StatusTypeDef HAL_InitTick (uint32_t TickPriority)
{
  ...
  TimHandle.Init.CounterMode = ((uint32_t)0x00000000U);
...
void HAL_SuspendTick(void)
{
  ...
  ((&TimHandle)->Instance ->DIER &= ~((0x0001U)));
}
