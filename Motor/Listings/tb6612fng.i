...
void TB6612FNG_Init(void) {
	...
	do { GPIO_InitTypeDef GPIO_InitStructure = {0}; GPIO_InitStructure . Pin = ((uint16_t)0x0002U) | ((uint16_t)0x0004U) | ((uint16_t)0x0010U); GPIO_InitStructure . Mode = ((uint32_t)0x00000001U); GPIO_InitStructure . Speed = ((uint32_t)0x00000003U); GPIO_InitStructure . Pull = ((uint32_t)0x00000000U); HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U)), &GPIO_InitStructure); } while(0);
	do { GPIO_InitTypeDef GPIO_InitStructure = {0}; GPIO_InitStructure . Pin = ((uint16_t)0x0008U); GPIO_InitStructure . Mode = ((uint32_t)0x00000002U); GPIO_InitStructure . Speed = ((uint32_t)0x00000003U); GPIO_InitStructure . Pull = ((uint32_t)0x00000000U); GPIO_InitStructure . Alternate = ((uint8_t)0x01U); HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0000U)), &GPIO_InitStructure); } while(0);
	...
	do { TIM_Base_InitTypeDef TIM_Base_InitStruct = {0}; TIM_Base_InitStruct . Prescaler = 84 - 1; TIM_Base_InitStruct . Period = 1000 - 1; TIM_Base_InitStruct . ClockDivision = ((uint32_t)0x00000000U); TIM_Base_InitStruct . CounterMode = ((uint32_t)0x00000000U); htim3 . Instance = ((TIM_TypeDef *) (0x40000000U + 0x0000U)); htim3 . Init = TIM_Base_InitStruct; if(HAL_TIM_Base_Init(&htim3) != HAL_OK) { Error_Handler(); } } while(0);
	do { TIM_OC_InitTypeDef TIM_OC_InitStruct = {0}; TIM_OC_InitStruct . OCMode = (0x0020U | 0x0040U); TIM_OC_InitStruct . Pulse = 0; TIM_OC_InitStruct . OCPolarity = ((uint32_t)0x00000000U); TIM_OC_InitStruct . OCFastMode = ((uint32_t)0x00000000U); if(HAL_TIM_PWM_ConfigChannel(&htim3, &TIM_OC_InitStruct, ((uint32_t)0x0000000CU)) != HAL_OK) { Error_Handler(); } } while(0);
	HAL_TIM_PWM_Start(&htim3, ((uint32_t)0x0000000CU));
}

void TB6612FNG_SetSpeed(uint16_t speed) {
	if(speed >= 1000) speed = 999;
	(*(volatile uint32_t *)(&((&htim3)->Instance ->CCR1) + ((((uint32_t)0x0000000CU)) >> 2U)) = (speed));
}
